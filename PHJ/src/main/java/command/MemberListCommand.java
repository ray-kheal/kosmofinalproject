...
public class MemberListCommand implements PHJCommandImpl {
	...
	public void execute(Model model) {
		...
		System.out.println("MemberListCommand > exectue()");
		...
		String pagingImg = util.PagingUtil.pagingImg(totalRecordCount,pageSize,blockPage, nowPage,
				req.getContextPath()+"/admin/pages/tables/memberManagement.do?"+addQueryString);
		...
		System.out.println("Member 리스트커맨드 잘끝냄 ^^");
		System.out.println();		
