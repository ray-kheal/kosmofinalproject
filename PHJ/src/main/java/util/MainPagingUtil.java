...
public class MainPagingUtil {
	...
	public static String pagingImg(int totalRecordCount, int pageSize, int blockPage, int nowPage, String page) {
		...
		if (intTemp <= totalPage) {
			pagingStr += "<a href='" + page + "nowPage=" + intTemp + "'>" + "<img src='../images/paging3.png'></a>";
			pagingStr += "&nbsp;";
			pagingStr += "<a href='" + page + "nowPage=" + totalPage + "'>"
					+ "<img src='/PHJ/src/main/webapp/resources/images/paging4.png'></a>";
		}
