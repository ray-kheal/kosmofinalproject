...
public class PagingUtil {
	// 페이지번호와 페이지블럭 이미지를 같이 출력해주는 메소드
	public static String pagingImg(int totalRecordCount, int pageSize, int blockPage, int nowPage, String page) {
		...
		if (intTemp != 1) {
			...
			// 두번째 페이지 블럭부터 출력됨.
			pagingStr += "" + "<a href='" + page + "nowPage=1'>" + "<img src='../../../images/paging1.png'></a>";
			pagingStr += "&nbsp;";
	...
	// 해주는 메소드
	public static String pagingImg_phj(int totalRecordCount, int pageSize, int blockPage, int nowPage, String page) {
		...
		if (intTemp != 1) {
			// 첫번째 페이지 블럭에서는 출력되지 않음
			// 두번째 페이지 블럭부터 출력됨.
			pagingStr += "" + "<a href='" + page + "nowPage=1'>" + "<img src='../../phj/images/paging1.png'></a>";
			pagingStr += "&nbsp;";
			pagingStr += "" + "<a href='" + page + "nowPage=" + (intTemp - blockPage) + "'>"
					+ "<img src='../../phj/images/paging2.png'></a>";
		}
		...
		if (intTemp <= totalPage) {
			pagingStr += "<a href='" + page + "nowPage=" + intTemp + "'>"
					+ "<img src='../../phj/images/paging3.png'></a>";

			pagingStr += "&nbsp;";
			pagingStr += "<a href='" + page + "nowPage=" + totalPage + "'>"
					+ "<img src='../../phj/images/paging4.png'></a>";
		}
