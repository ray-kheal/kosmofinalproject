...
<!-- 			<i class="fas fa-store" style="width: 45px; height: 45px;" ></i> -->
			&nbsp;	
				...
				<img src="https://image.flaticon.com/icons/svg/2082/2082361.svg" width="80px" height="80px" /> 
				찾는다 그리고 산다 먹을거
				<img src="https://image.flaticon.com/icons/svg/565/565370.svg" width="80px" height="80px" /> 
      </p>
   </div>
   <div style="width: 100%; text-align: center;">
      <br /> <br />
