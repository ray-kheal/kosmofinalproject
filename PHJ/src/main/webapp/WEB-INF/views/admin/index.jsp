	...
	<div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.do"><img src="assets/images/logo.png" alt="logo" /></a>
          ...
          <ul class="nav">
            ...
            <!-- <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.do">Buttons</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.do">Typography</a></li>
                </ul>
              </div>
            </li> 
            <li class="nav-item">
              <a class="nav-link" href="pages/icons/mdi.do">
                <span class="menu-title">Icons</span>
                <i class="mdi mdi-contacts menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pages/forms/basic_elements.do">
                <span class="menu-title">Forms</span>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pages/charts/chartjs.do">
                <span class="menu-title">Charts</span>
                <i class="mdi mdi-chart-bar menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pages/tables/basic-table.do">
            ...
            <li class="nav-item"> 
              ...
              <div class="collapse" id="board-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/tables/productManagement.do">공지사항</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/tables/placeManagement.do">레시피 게시판</a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/tables/placeManagement.do">이벤트 게시판</a></li>
                </ul>
              </div>
            </li> 
            ...
            <li class="nav-item">
              <a class="nav-link" href="pages/tables/boardManagement.do">
                <span class="menu-title">게시판관리</span>
                <i class="mdi mdi-table-large menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="pages/samples/blank-page.do"> Blank Page </a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/samples/login.do"> Login </a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/samples/register.do"> Register </a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/samples/error-404.do"> 404 </a></li>
                  <li class="nav-item"> <a class="nav-link" href="pages/samples/error-500.do"> 500 </a></li>
                </ul>
              </div>
            </li>
            ...
            <div class="row" id="proBanner">
              <div class="col-12">
               <!--  <span class="d-flex align-items-center purchase-popup">
                ...
                아래의 bannerClose 까지 주석처리하면 페이지 로딩은 되나 에러메시지가뜸.
                -->
