            ...
            <div class="page-header">
              ...
              <div class="container">
		       ...
		       <!--        <nav aria-label="breadcrumb">
				...
				<div class="card">
	                <div class="card-body">
	                    <h4 class="card-title "><i class="mdi mdi-lead-pencil"></i>&nbsp;답글쓰기</h4>
				 <form action="./qnaReplyAction.do" name="writeFrm" method="post" 
						...
						<input type="hidden" name="bindent" value = "${replyRow.bindent }" />
							<input type="hidden" name="board_type" value="1" /> 
		                     ...
		                     <div class="form-group">
		                       ...
		                       <textarea class="form-control" name="content" rows="10">${replyRow.content}</textarea>
		                     </div>
