	...
	<div class="container">
		...
		<form method="post" onsubmit="return sendIt();" class="" name="f">
				<table class="table table-borderless">
						...
						<tr>
							<td  colspan='2' style="font-size:18px; text-align: center;"><i class="fas fa-user-edit"></i> &nbsp;가입정보</td>
						...
						<tr valign="middle">
							...
							<td style="border-bottom: 6px solid #343a40;">
								<div class="form-inline">
					...
					<div class="form-inline">
						<button type="submit" class="btn btn-lg btn-dark" style="width:25%; margin-left:20%;margin-right:5%;">
							가입완료
						</button>
