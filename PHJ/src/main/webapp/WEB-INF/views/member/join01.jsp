...
<form action="join02.do" name="form" method="post">
	...
	<textarea class="Terms" style="padding-left:5;padding-right:50;padding-bottom:50;padding-top:50;word-break:break-all;width:100%" rows="10" cols="150">
		이용약관
...
부칙 (2019년 9월 3일 공고)
	...
	<div style="text-align:center; font-size: medium"><input type="checkbox" name="req1" value=""/>&nbsp; 편히점 이용약관에 동의합니다.</div>
	...
	<textarea class="Terms" style="padding-left:5;padding-right:50;padding-bottom:50;padding-top:50;word-break:break-all;width:100%" rows="10" cols="150">가. 수집하는 개인정보의 항목첫째, 회사는 회원가 입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 최소한의 개인정보를 필수항목으로 수집하고 있습니다.
		편히점 개인정보 취급방침
...
• 시행일자: 2019년 9월 4일
	...
	<div style="text-align:center; font-size: medium" ><input type='checkbox' name='req2' value='yes' />개인정보 취급방침에 동의합니다.</div>
	...
	<p style="text-align:center; margin-bottom:20px"><a href="#"><img src="resources/images/btn01.gif" onclick="chk()"/></a>&nbsp;&nbsp;<a href="#"><img src="resources/images/btn02.gif" onclick="nochk()"/></a></p>
					...
					<footer id="footer" class="container">
						<div class="row">
							<div class="col-12">
								<div id="copyright">
									<ul class="menu">
										<li style=" font-size : xx-small";> 고객센터 l 개인정보취급방침 l 오류문의 enendxkr@naver.com <br />
													편히점Copyrightⓒ편히점 All Rights Reserved.
										</li>
									</ul>
								</div>
							</div>
